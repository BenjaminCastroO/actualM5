...
VALUES
  ...
  ('Daniel Miller', 'danielmiller', 'password5'),
  ('Olivia Wilson', 'oliviawilson', 'password6'),
  ('David Taylor', 'davidtaylor', 'password7'),
  ('Sophia Anderson', 'sophiaanderson', 'password8'),
  ('James Thomas', 'jamesthomas', 'password9'),
  ('Emma Jackson', 'emmajackson', 'password10'),
  ('Mary Johnson', 'maryjohnson', 'password11'),
  ('William Smith', 'williamsmith', 'password12'),
  ('Sophia Miller', 'sophiamiller', 'password13'),
  ('James Brown', 'jamesbrown', 'password14'),
  ('Olivia Taylor', 'oliviataylor', 'password15'),
  ('Liam Anderson', 'liamanderson', 'password16'),
  ('Ava Thomas', 'avathomas', 'password17'),
  ('Noah Johnson', 'noahjohnson', 'password18'),
  ('Isabella Smith', 'isabellasmith', 'password19'),
  ('Mia Miller', 'miamiller', 'password20'),
  ('Andrew Davis', 'andrewdavis', 'password21'),
  ('Emma Wilson', 'emmawilson', 'password22'),
  ('Matthew Thomas', 'matthewthomas', 'password23'),
  ('Olivia Garcia', 'oliviagarcia', 'password24'),
  ('Ethan Martinez', 'ethanmartinez', 'password25'),
  ('Sophia Robinson', 'sophiarobinson', 'password26'),
  ('Liam Clark', 'liamclark', 'password27'),
  ('Ava Hernandez', 'avahernandez', 'password28'),
  ('Noah Young', 'noahyoung', 'password29'),
  ('Isabella Lee', 'isabellalee', 'password30');
